...
Objective:
i. Web based application for online browsing and search of menu aggregated from multiple restaurants e.g., the services provided by commercial websites.
...
Optionally, the database of restaurants may be populated using the API offered by Zomato for a particular city say Tokyo.
ii. The system should provide a restaurant/customer registration module.
iii. The system should allow customers to place orders and track their orders through different stages of delivery.
iv. The system should offer billing facility.
v. The system should track user history and suggest favorites (bonus points).
